...
import { GraduationCap, BookOpen, FileCheck, Award, Calendar, ChartBar, Settings, User, Library, Brain, Map, Briefcase, Search, Route, GitCompare, CalendarDays, Activity, BarChart3, FileText, Users, Link, Bell, GitBranch, ClipboardList, FileStack } from 'lucide-vue-next'
...
const navigationButtons = computed(() => {
  ...
  const allButtons = [
    ...
    { icon: FileStack, title: 'Конструктор рабочих программ', link: 'LMSWorkProgramsConstructor', roles: ['teacher', 'admin'] },
